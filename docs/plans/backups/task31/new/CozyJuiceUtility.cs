...
namespace CozyLifeSim.UI
{
    public class CozyJuiceUtility : MonoBehaviour
    {
        ...
        {
            if (_coinTargetTransform == null || !Application.isPlaying)
            {
                return;
            }
            ...
            Vector3 targetWorldPos = _coinTargetTransform.position;
            ...
            for (int i = 0; i < coinCount; i++)
            {
                ...
                seq.Append(coin.transform.DOMove(targetWorldPos, 0.42f).SetEase(Ease.InQuad));
